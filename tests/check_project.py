...
REQUIRED_FILES = (
    ...
    "uvmapping/texture_errors.py",
    "uvmapping/texture_pipeline.py",
    "uvmapping/texture_presets.py",
    ...
    "tests/test_texture_errors_pure.py",
    "tests/test_texture_job_pure.py",
    "tests/test_texture_pipeline_pure.py",
    "tests/test_texture_presets_pure.py",
    "README.md",
    "CHANGELOG.md",
    "LICENSE",
)
...
def _check_release_lock() -> None:
    ...
    expected = [
        ...
        },
        {
            "tag": "v2.5.1",
            "version": "2.5.1",
            "asset_name": "uvmapping_blender-v2.5.1.zip",
            "url": "https://github.com/zzamjak-cloud/UVmapping-Blender/releases/download/v2.5.1/uvmapping_blender-v2.5.1.zip",
            "size": 161394,
